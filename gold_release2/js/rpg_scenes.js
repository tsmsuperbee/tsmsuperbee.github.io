...
Scene_Map.prototype.updateJournalScene= function() {
    if(Input.isTriggered("journal")){
        AudioManager.playSe({name: "journal", pan: 0, pitch: 100, volume: 100});
        SceneManager.push(Scene_Notepad) // call the scene
   }
};
Scene_Map.prototype.updateCounter= function() {
    var counter = $gameVariables.value(19);
    counter += 1;
    $gameVariables.setValue(19,counter);
};
